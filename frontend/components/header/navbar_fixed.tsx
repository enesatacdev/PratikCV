            ...
            <Link
              ...
              className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                isActive('/premium') 
                  ...
                  : 'text-purple-600 hover:text-white hover:bg-gradient-to-r hover:from-purple-500 hover:to-purple-600 border border-purple-200 hover:border-transparent'
              }`}
            >
              💎 Premium Fiyatları
            </Link>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <Link
              ...
              className={`block px-3 py-2 rounded-md text-base font-medium ${
                isActive('/premium') 
                  ? 'text-white bg-gradient-to-r from-purple-600 to-purple-700' 
                  : 'text-purple-600 hover:text-white hover:bg-gradient-to-r hover:from-purple-500 hover:to-purple-600'
              }`}
              onClick={() => setIsOpen(false)}
            >
              💎 Premium Fiyatları
